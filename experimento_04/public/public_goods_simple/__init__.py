...
class Change_Payoff(Page):
    ...
    def vars_for_template(player: Player):
        group = player.group
        condition_P1 = group.get_player_by_id(1).participant.number % 5 == 1 and group.round_number >= C.FIRST_CHANGE_ROUND or group.get_player_by_id(1).participant.number % 5 == 2 and group.round_number >= C.SECOND_CHANGE_ROUND  or group.get_player_by_id(1).participant.number % 5 == 3 and group.round_number >= C.THIRD_CHANGE_ROUND or group.get_player_by_id(1).participant.number % 5 == 4 and group.round_number >= C.FOURTH_CHANGE_ROUND or group.get_player_by_id(1).participant.number % 5 == 0 and group.round_number >= C.FIFTH_CHANGE_ROUND
        ...
        return dict(
            ...
            condition_P2=condition_P2,
            condition_P3=condition_P3,
            condition_P4=condition_P4,
        )
